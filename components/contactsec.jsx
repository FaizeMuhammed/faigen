    ...
    >
      ...
      {mounted && (
        ...
        >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
              ...
              >
                ...
                <form onSubmit={handleFormSubmit} className="space-y-6">
                  ...
                  <div>
                    <label htmlFor="phoneNumber" className="block text-sm font-medium text-black/70 mb-2">Phone Number (Optional)</label>
                    <input
                      type="tel"
                      id="phoneNumber"
                      name="phoneNumber"
          ...
          {/* Social media links - Removed Twitter/X and GitHub, kept only LinkedIn and Instagram */}
          <motion.div 
